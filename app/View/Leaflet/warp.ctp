...
<html>
    ...
    <body>
        ...
        <script src='/assets/js/warp/enemy.js'></script>
        <script src='/assets/js/warp/building.js'></script>
        <script src='/assets/js/warp/player.js'></script>
        <script src='/assets/js/warp/target.js'></script>
        <script src='/assets/js/warp/main.js'></script>
    </body>
</html>